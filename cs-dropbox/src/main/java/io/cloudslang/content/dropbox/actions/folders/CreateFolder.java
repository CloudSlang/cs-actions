 ...
 *
 *******************************************************************************/
package io.cloudslang.content.dropbox.actions.folders;
...
import static io.cloudslang.content.dropbox.entities.constants.Inputs.CommonInputs.API_VERSION;
...
public class CreateFolder {
     ...
     *                             bellow example.
     *                             Example: "https://api.dropboxapi.com"
     * @param accessToken          Token obtained within DropBox account associated with a specific user and application
     *                             pair.
     *                             Example: "qomoftv0472git7"
     * @param apiVersion           Optional - Dropbox API version.
    ...
    public Map<String, String> execute(@Param(value = ENDPOINT, required = true) String endpoint,
                                       @Param(value = ACCESS_TOKEN, required = true, encrypted = true) String accessToken,
                                       @Param(value = API_VERSION) String apiVersion,
