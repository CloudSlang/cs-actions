...
import static io.cloudslang.content.couchbase.utils.InputsUtil.toAppend;
...
public class UriFactory {
    ...
    public static String getUri(InputsWrapper wrapper) {
        switch (wrapper.getCommonInputs().getApi()) {
            case BUCKETS:
                return toAppend(CouchbaseApi.BUCKETS.getValue(), getBucketsUri(wrapper), wrapper.getCommonInputs().getAction());
            default:
