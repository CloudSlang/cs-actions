...
public class ExceptionMessages {
    public static final String CREATE_INSTANCE_EXCEPTION = "Failed to create instance.";
    public static final String DELETE_INSTANCE_EXCEPTION = "Failed to delete instance.";
