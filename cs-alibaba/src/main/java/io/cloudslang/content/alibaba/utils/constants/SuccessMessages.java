...
public class SuccessMessages {
    public static final String CREATE_INSTANCE_SUCCESS = "The instance create request was successfully executed, and the instance id is ";
    public static final String DELETE_INSTANCE_SUCCESS = "The instance delete request was successfully executed.";
