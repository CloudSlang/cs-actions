...
import static io.cloudslang.content.winrm.utils.InputsValidation.verifyPowerShellScriptInputs;
...
//        useSubjectCredsOnly = defaultIfEmpty(useSubjectCredsOnly, EMPTY);
        ...
        final List<String> exceptionMessages = verifyPowerShellScriptInputs(proxyPort, trustAllRoots, operationTimeout, requestNewKerberosToken,
                authType, x509HostnameVerifier, trustKeystore, keystore, port, tlsVersion, protocol);
