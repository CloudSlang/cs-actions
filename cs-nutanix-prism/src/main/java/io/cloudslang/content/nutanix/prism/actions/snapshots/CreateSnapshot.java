package io.cloudslang.content.nutanix.prism.actions.snapshots;
...
import static io.cloudslang.content.nutanix.prism.services.SnapshotImpl.createSnapshot;
import static io.cloudslang.content.nutanix.prism.utils.Constants.Common.*;
import static io.cloudslang.content.nutanix.prism.utils.Constants.CreateSnapshotConstants.CREATE_SNAPSHOT_OPERATION_NAME;
import static io.cloudslang.content.nutanix.prism.utils.Constants.CreateSnapshotConstants.TASK_UUID_PATH;
import static io.cloudslang.content.nutanix.prism.utils.Descriptions.Common.*;
import static io.cloudslang.content.nutanix.prism.utils.Descriptions.CreateSnapshot.*;
...
import static io.cloudslang.content.nutanix.prism.utils.Inputs.CreateSnapshotInputs.*;
...
public class CreateSnapshot {
    @Action(name = CREATE_SNAPSHOT_OPERATION_NAME,
            description = CREATE_SNAPSHOT_OPERATION_DESC,
            outputs = {
    ...
    public Map<String, String> execute(@Param(value = HOSTNAME, required = true, description = HOSTNAME_DESC) String hostname,
                                       ...
                                       @Param(value = SNAPSHOT_NAME, required = true, description = SNAPSHOT_NAME_DESC) String snapshotName,
        ...
        try {
            final Map<String, String> result = createSnapshot(NutanixCreateSnapshotInputs.builder()
