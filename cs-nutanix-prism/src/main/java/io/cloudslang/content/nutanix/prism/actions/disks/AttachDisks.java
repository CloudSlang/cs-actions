...
import static io.cloudslang.content.nutanix.prism.utils.Descriptions.AttachDisks.*;
...
import static io.cloudslang.content.nutanix.prism.utils.Inputs.AttachDisksInputs.*;
...
public class AttachDisks {
    @Action(name = ATTACH_DISKS_OPERATION_NAME,
            description = ATTACH_DISKS_OPERATION_DESC,
            outputs = {
