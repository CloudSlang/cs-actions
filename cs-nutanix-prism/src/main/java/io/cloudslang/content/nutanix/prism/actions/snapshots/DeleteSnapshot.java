...
import static io.cloudslang.content.nutanix.prism.services.SnapshotImpl.deleteSnapshot;
...
import static io.cloudslang.content.nutanix.prism.utils.Descriptions.DeleteSnapshot.*;
...
import static io.cloudslang.content.nutanix.prism.utils.Inputs.DeleteSnapshotInputs.*;
...
public class DeleteSnapshot {
    ...
    public Map<String, String> execute(@Param(value = HOSTNAME, required = true, description = HOSTNAME_DESC) String hostname,
                                       ...
                                       @Param(value = SNAPSHOT_UUID, required = true, description = SNAPSHOT_UUID_DESC) String snapshotUUID,
