package io.cloudslang.content.nutanix.prism.actions.snapshorts;
...
import io.cloudslang.content.nutanix.prism.entities.NutanixDeleteVMInputs;
...
import static io.cloudslang.content.httpclient.entities.HttpClientInputs.*;
        import static io.cloudslang.content.nutanix.prism.services.SnapshotImpl.deleteSnapshot; // service layer
import static io.cloudslang.content.nutanix.prism.services.VMImpl.deleteVM;
import static io.cloudslang.content.nutanix.prism.utils.Constants.Common.*;
        import static io.cloudslang.content.nutanix.prism.utils.Constants.DeleteSnapshotConstants.TASK_UUID_PATH;
import static io.cloudslang.content.nutanix.prism.utils.Descriptions.Common.*;
import static io.cloudslang.content.nutanix.prism.utils.Descriptions.DeleteVM.DELETE_SNAPSHOTS_DESC;
import static io.cloudslang.content.nutanix.prism.utils.Descriptions.DeleteVM.LOGICAL_TIMESTAMP_DESC;
...
import static io.cloudslang.content.nutanix.prism.utils.Descriptions.DeleteSnapshot.DELETE_SNAPSHOT_OPERATION_DESC;
import static io.cloudslang.content.nutanix.prism.utils.Constants.DeleteSnapshotConstants.DELETE_SNAPSHOT_OPERATION_NAME;
import static io.cloudslang.content.nutanix.prism.utils.Constants.DeleteSnapshotConstants.DELETE_SNAPSHOT_PATH ;


import static io.cloudslang.content.nutanix.prism.utils.Inputs.DeleteSnapshotInputs.DELETE_SNAPSHOTS;
import static io.cloudslang.content.nutanix.prism.utils.Inputs.DeleteSnapshotInputs.LOGICAL_TIMESTAMP;
...
import static io.cloudslang.content.nutanix.prism.utils.Outputs.GetTaskDetailsOutputs.SNAPSHORT_UUID;
import static io.cloudslang.content.nutanix.prism.utils.Outputs.GetTaskDetailsOutputs.VM_UUID; // kept for parity; unused here
...
public class DeleteSnapshot {
    ...
    @Action(name = DELETE_SNAPSHOT_OPERATION_NAME,
            description = DELETE_SNAPSHOT_OPERATION_DESC,
            outputs = {
    ...
    public Map<String, String> execute(@Param(value = HOSTNAME, required = true, description = HOSTNAME_DESC) String hostname,
                                       ...
                                       @Param(value = SNAPSHORT_UUID, required = true, description = SNAPSHORT_UUID_DESC) String snapshotUUID,
                                       @Param(value = DELETE_SNAPSHOTS, description = DELETE_SNAPSHOTS_DESC) String deleteSnapshots,
                                       @Param(value = Inputs.DeleteSnapshotInputs.LOGICAL_TIMESTAMP, description = LOGICAL_TIMESTAMP_DESC) String logicalTimestamp,
        ...
        deleteSnapshots = defaultIfEmpty(deleteSnapshots, BOOLEAN_TRUE);
        logicalTimestamp = defaultIfEmpty(logicalTimestamp, EMPTY);
        ...
        try {
            final Map<String, String> result = deleteSnapshot(NutanixDeleteSnapshotInputs.builder()
            ...
            final Map<String, String> outputs = getOperationResults(result, returnMessage, returnMessage, returnMessage);
            final int statusCode = Integer.parseInt(result.get(STATUS_CODE));
            if (statusCode >= 200 && statusCode < 300) {
                final String taskUUID = JsonPath.read(returnMessage, TASK_UUID_PATH);
                outputs.put(TASK_UUID, taskUUID);
            } else {
