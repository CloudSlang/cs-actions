...
import static io.cloudslang.content.nutanix.prism.utils.Inputs.DetachDisksInputs.*;
...
public class DetachDisks {
    @Action(name = DETACH_DISKS_OPERATION_NAME,
            description = DETACH_DISKS_OPERATION_DESC,
            outputs = {
