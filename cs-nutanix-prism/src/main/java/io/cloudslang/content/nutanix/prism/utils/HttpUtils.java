...
public class HttpUtils {
    ...
    public static String getQueryParams(String filter,String offset,String length,
        ...
        final StringBuilder queryParams = new StringBuilder()
                .append(Constants.Common.QUERY)
                .append(Constants.GetListDetailsConstants.FILTER)
                .append(filter)
                .append(Constants.Common.AND)
                .append(Constants.GetListDetailsConstants.OFFSET)
                .append(offset)
                .append(Constants.Common.AND)
                .append(Constants.GetListDetailsConstants.LENGTH)
                .append(length)
                .append(Constants.Common.AND)
                .append(Constants.GetListDetailsConstants.SORT_ORDER)
                .append(sortorder)
                .append(Constants.Common.AND)
                .append(Constants.GetListDetailsConstants.SORT_ATTRIBUTE)
