...
public abstract class AbstractPostRequestServiceTest<R extends AbbyyRequest> {
    ...
    AbstractPostRequestService<R> sut;
    @Rule
    public ExpectedException exception = ExpectedException.none();
    @Mock
    AbbyyRequestValidator<R> requestValidatorMock;
    @Mock
    ...
    public void execute_notEnoughCredits_AbbyySdkException() throws Exception {
        ...
        when(this.abbyyApiMock.postRequest(eq(request), anyString())).thenReturn(responseMock);
    ...
    abstract AbstractPostRequestService<R> newSutInstance();
