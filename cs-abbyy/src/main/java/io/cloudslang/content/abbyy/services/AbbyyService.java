...
public abstract class AbbyyService<R extends AbbyyInput> {

    final AbbyyApi abbyyApi;
    private final AbbyyInputValidator<R> requestValidator;
    boolean timedOut;


    AbbyyService(@NotNull AbbyyInputValidator<R> requestValidator, @NotNull AbbyyApi abbyyApi) {
    ...
    public Map<String, String> execute(@NotNull R request) throws Exception {
        ...
        try {
            ...
            AbbyyResponse response = this.abbyyApi.request(request);
