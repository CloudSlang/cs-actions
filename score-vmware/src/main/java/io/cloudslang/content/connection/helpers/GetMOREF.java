package io.cloudslang.content.connection.helpers;

import com.vmware.vim25.*;
import io.cloudslang.content.connection.Connection;
import io.cloudslang.content.connection.helpers.build.ObjectSpecBuilder;
import io.cloudslang.content.connection.helpers.build.PropertyFilterSpecBuilder;
import io.cloudslang.content.connection.helpers.build.PropertySpecBuilder;
import io.cloudslang.content.connection.helpers.build.TraversalSpecBuilder;
