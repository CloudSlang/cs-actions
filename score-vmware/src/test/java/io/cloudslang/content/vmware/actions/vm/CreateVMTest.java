...
public class CreateVMTest {
    ...
    public void testCreatesVM() throws Exception {
        ...
        when(vmServiceMock.createVirtualMachine(any(HttpInputs.class), any(VmInputs.class))).thenReturn(resultMap);

        resultMap = createVM.createVM("", "", "", "", "", "", "", "", "", "", "", "", "", "", "");

        assertNotNull(resultMap);
        verify(vmServiceMock).createVirtualMachine(any(HttpInputs.class), any(VmInputs.class));
    }
