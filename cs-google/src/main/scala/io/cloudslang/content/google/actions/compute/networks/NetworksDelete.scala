package io.cloudslang.content.google.actions.compute.networks
...
import io.cloudslang.content.google.services.compute.networks.NetworkService
...
/**
  ...
  */
class NetworksDelete {

  /**
    * This operation can be used to delete a Network resource. The operation returns a ZoneOperation resource as a
    ...
    * @param networkName      Name of the Network resource to delete.
    *                         Example: "default"
