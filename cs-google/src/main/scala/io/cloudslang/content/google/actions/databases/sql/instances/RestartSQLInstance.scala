...
import io.cloudslang.content.google.utils.Constants.SQLInstancesConstant.RESTART_SQL_INSTANCE_OPERATION_NAME
...
import io.cloudslang.content.google.utils.action.Descriptions.SQLDataBaseInstances.RESTART_SQL_INSTANCE_OPERATION_DESCRIPTION
...
class RestartSQLInstance {
  @Action(name = RESTART_SQL_INSTANCE_OPERATION_NAME,
    description = RESTART_SQL_INSTANCE_OPERATION_DESCRIPTION,
    outputs = Array(
