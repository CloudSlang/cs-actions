...
public class DeleteBlob {
    ...
    public Map<String, String> execute(@Param(value = STORAGE_ACCOUNT, required = true) String storageAccount,
        ...
        final List<String> exceptionMessages = verifyStorageInputs(storageAccount, key, containerName, proxyPort, blobName, timeout);
        ...
        try {
            return getSuccessResultsMap(StorageServiceImpl.deleteBlob(storageInputs));
