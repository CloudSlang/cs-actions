...
import static io.cloudslang.content.azure.utils.Constants.Common.ACCOUNT_KEY;
...
public class GetOutput {
    ...
    public Map<String, String> execute(@Param(value = JOB_NAME, required = true, description = JOB_NAME_DESC) String jobName,
        ...
        try {
            final Map<String, String> result = StreamingJobImpl.CreateOutputJob(CreateStreamingOutputJobInputs.builder()
