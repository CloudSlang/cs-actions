...
import static io.cloudslang.content.redhat.utils.Descriptions.CreateBuild.*;
import static io.cloudslang.content.redhat.utils.Descriptions.CreateBuild.EXCEPTION_DESC;
import static io.cloudslang.content.redhat.utils.Descriptions.CreateBuild.RETURN_RESULT_DESC;
...
public class CreateBuild {
    ...
    @Action(name = CREATE_BUILD,
            description = CREATE_BUILD_DESC,
            outputs = {
    ...
    public Map<String, String> execute(
            ...
            @Param(value = SPECIFICATION, description = SPECIFICATION_DESC, required = true) String body,
            @Param(value = NAMESPACE, description = NAMESPACE_DESC, required = true) String namespace,
            @Param(value = BUILD_CONFIG, description = BUILD_CONFIG_DESC, required = true) String buildConfig,
        ...
        try {
            ...
            Map<String, String> result = new HttpClientPostAction().execute(
                    host + CREATE_BUILD_ENDPOINT_1 + namespace + CREATE_BUILD_ENDPOINT_2 + buildConfig + CREATE_BUILD_ENDPOINT_3,
                    ANONYMOUS,
                    EMPTY,
                    EMPTY,
                    TRUE,
