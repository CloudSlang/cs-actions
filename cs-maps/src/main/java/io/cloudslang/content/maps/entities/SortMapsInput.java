...
public class SortMapsInput {
    ...
    public SortMapsInput(Builder builder) {
    ...
    public static class Builder {
        ...
        public Builder sortBy(String sortBy) {
            this.sortBy = StringUtils.defaultString(sortBy, DefaultInputValues.SORT_BY);
            return this;
        }


        public Builder sortOrder(String sortOrder) {
            this.sortOrder = StringUtils.defaultString(sortOrder, DefaultInputValues.SORT_ORDER);
            return this;
        }
        ...
        public SortMapsInput build() {
            return new SortMapsInput(this);
        }
    }
}