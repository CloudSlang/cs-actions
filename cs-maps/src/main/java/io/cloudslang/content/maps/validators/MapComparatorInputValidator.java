...
public class MapComparatorInputValidator {

    public ValidationException validateMatchType(@NotNull MapComparatorInput input) {
        ...
        try {
            ...
            FieldValidator.validateEntryMatchType(input.getMatchType());
            return null;
