...
public final class InputsValidation {
    ...
    @NotNull
    public static List<String> verifyGetMessageInputs(@Nullable final String messageId, @Nullable final String proxyPort, @Nullable final String trust_all_roots,
