...
public class DescribeImagesInRegionAction {
    ...
    public Map<String, String> execute(@Param(value = Inputs.CommonInputs.PROVIDER, required = true) String provider,
                                       ...
                                       @Param(Inputs.CustomInputs.IMAGE_IDS_STRING) String imageIdsString,
                                       @Param(Inputs.CustomInputs.OWNERS_STRING) String ownersString) throws Exception {
        ...
        try {
            return new DescribeImagesInRegionExecutor().execute(inputs, customInputs);
