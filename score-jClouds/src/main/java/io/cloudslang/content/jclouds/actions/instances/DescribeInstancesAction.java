...
public class DescribeInstancesAction {
     ...
     * @param blockMappingDeviceName                 Optional - device name for the EBS volume. Ex: "/dev/sdh" or "xvdh"
     ...
     *                                               the instance in the launch group. Ex: 0, 1, 2, and so on.
