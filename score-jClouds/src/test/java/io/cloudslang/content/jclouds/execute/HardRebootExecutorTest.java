...
@PrepareForTest({HardRebootExecutor.class, ComputeFactory.class})
public class HardRebootExecutorTest {
    ...
    @Spy
    private HardRebootExecutor toTest = new HardRebootExecutor();
