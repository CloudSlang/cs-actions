...
public class SoftRebootExecutorTest {
    ...
    public void testExecute() throws Exception {
        ...
        Mockito.doNothing().when(computeServiceMock).softReboot(REGION, SERVER_ID);
        ...
        verify(computeServiceMock).softReboot(REGION, SERVER_ID);
    ...
    public void testExecuteNegativeScenario() throws Exception {
        ...
        Mockito.doThrow(toThrow).when(computeServiceMock).softReboot(REGION, SERVER_ID);
