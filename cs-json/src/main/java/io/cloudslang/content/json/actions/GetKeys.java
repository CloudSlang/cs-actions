...
public class GetKeys {
     ...
     * * <p/>
     * * <br><br><b>returnResult</b> - This will contain the keys for the specified json path.
    ...
    @Action(name = "Get Keys", description = "Retrieves keys from a JSON object at a given JSON path",
            outputs = {
        ...
        try {
            ...
            if (!jsonNode.isNull()) {
                ...
                try {
                    ...
                    Map<String, Object> treeMap = mapper.readValue(jsonNode.toString(), Map.class);
                    Set<String> keys = treeMap.keySet();
                    if (treeMap.size() == 0)
                        return getFailureResultsMap("There are no keys");
                    return getSuccessResultsMap(keys.toString());
