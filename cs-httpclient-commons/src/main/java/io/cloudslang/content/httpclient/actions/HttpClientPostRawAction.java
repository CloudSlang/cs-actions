...
public class HttpClientPostRawAction {

    @Action(name = HTTP_CLIENT_POST_RAW_ACTION,
    ...
    public Map<String, String> execute(
            ...
            // Body Options (Form/Raw/File)
            @Param(value = FORM_PARAMS, description = FORM_PARAMS_DESC) String formParams,
            @Param(value = FORM_PARAMS_ARE_URLENCODED, description = FORM_PARAMS_ARE_URLENCODED_DESC) String formParamsAreURLEncoded,
