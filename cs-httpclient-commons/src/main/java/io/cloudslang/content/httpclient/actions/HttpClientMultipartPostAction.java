...
public class HttpClientMultipartPostAction {

    @Action(name = HTTP_CLIENT_MULTIPART_POST_ACTION,
    ...
    public Map<String, String> execute(
            ...
            @Param(value = MULTIPART_BODIES, description = MULTIPART_BODIES_DESC) String multipartBodies,
            @Param(value = MULTIPART_BODIES_CONTENT_TYPE, description = MULTIPART_BODIES_CONTENT_TYPE_DESC) String multipartBodiesContentType,
            @Param(value = MULTIPART_FILES, description = MULTIPART_FILES_DESC) String multipartFiles,
            @Param(value = MULTIPART_FILES_CONTENT_TYPE, description = MULTIPART_FILES_CONTENT_TYPE_DESC) String multipartFilesContentType,
