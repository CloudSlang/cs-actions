 ...
 * Copyright 2022-2025 Open Text
 * This program and the accompanying materials
 * are made available under the terms of the Apache License v3.0 which accompany this distribution.
 *
 * The Apache License is available at
 * http://www.apache.org/licenses/LICENSE-2.0
 *
...
public class HttpClientOptionsAction {

    @Action(name = HTTP_CLIENT_OPTIONS_ACTION,
    ...
    public Map<String, String> execute(
        ...
        try {
            ...
            return ErrorHandler.handleErrors(ex, new HashMap<>());
        }
    }
}
