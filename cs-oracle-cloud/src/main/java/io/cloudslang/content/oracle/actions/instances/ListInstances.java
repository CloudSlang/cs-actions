...
import static io.cloudslang.content.oracle.utils.Constants.ListInstancesConstants.INSTANCES_LIST_JSON_PATH;
...
import static io.cloudslang.content.oracle.utils.HttpUtils.getFailureResults;
import static io.cloudslang.content.oracle.utils.HttpUtils.getOperationResults;
import static io.cloudslang.content.oracle.utils.Inputs.CommonInputs.API_VERSION;
import static io.cloudslang.content.oracle.utils.Inputs.CommonInputs.PROXY_HOST;
import static io.cloudslang.content.oracle.utils.Inputs.CommonInputs.PROXY_PASSWORD;
import static io.cloudslang.content.oracle.utils.Inputs.CommonInputs.PROXY_PORT;
import static io.cloudslang.content.oracle.utils.Inputs.CommonInputs.PROXY_USERNAME;
import static io.cloudslang.content.oracle.utils.Inputs.ListInstancesInputs.COMPARTMENT_OCID;
import static io.cloudslang.content.oracle.utils.InputsValidation.verifyCommonInputs;
    ...
    public Map<String, String> execute(@Param(value = TENANCY_OCID, required = true, description = TENANCY_OCID_DESC) String tenancyOcid,
        ...
        try {
            ...
            if (statusCode >= 200 && statusCode < 300) {
                final List<String> instance_list = JsonPath.read(returnMessage, INSTANCES_LIST_JSON_PATH);
                if (!instance_list.isEmpty()) {
                    final String instanceListAsString = join(instance_list.toArray(), DELIMITER);
                ...
                return getFailureResults(compartmentOcid,statusCode,returnMessage);
            }
            return results;
