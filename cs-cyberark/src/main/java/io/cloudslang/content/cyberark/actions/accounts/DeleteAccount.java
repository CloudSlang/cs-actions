...
import static io.cloudslang.content.cyberark.utils.Constants.DeleteAccountConstants.*;
import static io.cloudslang.content.cyberark.utils.Constants.OtherConstants.*;
import static io.cloudslang.content.cyberark.utils.CyberarkUtils.removeUnusedHttpResults;
    ...
    public Map<String, String> execute(
        ...
        try {
            ...
            Map<String, String> result = new HttpClientDeleteAction().execute(
                    protocol + PROTOCOL_DELIMITER + hostname + DELETE_ACCOUNT_ENDPOINT + FORWARD_SLASH + id,
                    ANONYMOUS,
                    EMPTY,
                    EMPTY,
                    EMPTY,
