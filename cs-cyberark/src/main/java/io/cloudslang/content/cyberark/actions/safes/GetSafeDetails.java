...
import static io.cloudslang.content.cyberark.utils.Constants.CommonConstants.CONNECTIONS_MAX_TOTAL_DESCRIPTION;
import static io.cloudslang.content.cyberark.utils.Constants.GetSafeDetailsConstants.*;
...
public class GetSafeDetails {
    @Action(name = GET_SAFE_DETAILS,
            description = GET_SAFE_DETAILS_DESCRIPTION,
            outputs = {
    ...
    public Map<String, String> execute(
            ...
            @Param(value = USE_CACHE, description = USE_CACHE_DESCRIPTION) String useCache,
        ...
        queryParams.put(USE_CACHE, useCache);
        ...
        try {
            ...
            Map<String, String> result = new HttpClientGetAction().execute(
                    protocol + PROTOCOL_DELIMITER + hostname + GET_SAFE_DETAILS_ENDPOINT + safeUrlId,
                    ANONYMOUS,
                    EMPTY,
                    EMPTY,
                    EMPTY,
