...
public abstract class SSHShellAbstract {
    ...
    public SSHService getFromCache(SSHShellInputs sshShellInputs, String sessionId) {
        if (sessionId != null) {
    ...
    public boolean saveToCache(GlobalSessionObject<Map<String, SSHConnection>> sessionParam, SSHService service, String sessionId) {
    ...
    public void populateResult(Map<String, String> returnResult, Throwable e) {
