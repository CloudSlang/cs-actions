...
public class SQLUtils {
     ...
     * @throws SQLException If it was not a successful dump command's exception.
     */
     ...
     * @return The output of the dump command
     * @throws SQLException If it was not a successful load command's exception.
     */
    ...
    @NotNull
    public static List<String> getRowsFromStepSerializableSessionMap(@NotNull final StepSerializableSessionObject stepSerializableSessionObject, @NotNull final String aKey) {
        final Map<String, Object> stepSerializableMap = (Map<String, Object>)stepSerializableSessionObject.getValue();
        if (stepSerializableMap.containsKey(aKey)) {
            try {
                return (List<String>) stepSerializableMap.get(aKey);
            } catch (Exception e) {
                stepSerializableMap.remove(aKey);
                stepSerializableSessionObject.setValue(new SQLSessionResource(stepSerializableMap));
            }
        }
        return new ArrayList<>();
    }
