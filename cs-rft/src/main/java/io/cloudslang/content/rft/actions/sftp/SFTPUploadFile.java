...
public class SFTPUploadFile {
    ...
    public Map<String, String> execute(@Param(value = PARAM_HOST, description = PARAM_HOST_DESC, required = true) String host,
                                       ...
                                       @Param(value = PARAM_REMOTE_LOCATION, description = PARAM_REMOTE_LOCATION_DESC, required = true) String remoteLocation,
                                       @Param(value = PARAM_LOCAL_FILE, description = PARAM_LOCAL_FILE_DESC, required = true) String localFile,
