...
public class SFTPCreateDirectory {
    ...
    public Map<String, String> execute(@Param(value = HOST, description = HOST_NAME, required = true) String host,
                                       ...
                                       @Param(value = REMOTE_PATH, description = REMOTE_PATH_CREATE_DESC) String remotePath,
                                       @Param(value = REMOTE_FILE, description = REMOTE_FILE_CREATE_DIR, required = true) String remoteFile,
