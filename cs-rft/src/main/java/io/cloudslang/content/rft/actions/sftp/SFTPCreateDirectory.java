...
public class SFTPCreateDirectory {
    ...
    public Map<String, String> execute(@Param(value = HOST, description = HOST_NAME, required = true) String host,
        ...
        SFTPGeneralDirectoryInputs sftpGeneralDirectoryInputs = SFTPGeneralDirectoryInputs.builder()
        ...
        return new SFTPService().execute(sftpGeneralDirectoryInputs, SFTPOperation.CREATE_DIRECTORY);
    }
}
