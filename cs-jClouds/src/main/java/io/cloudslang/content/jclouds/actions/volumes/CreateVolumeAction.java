...
import io.cloudslang.content.jclouds.services.impl.AWSApiVolumeServiceImpl;
...
public class CreateVolumeAction {
    ...
    public Map<String, String> createVolume(@Param(value = Inputs.CommonInputs.ENDPOINT, required = true) String endpoint,
                                            ...
                                            @Param(value = Inputs.AWSApiInputs.VERSION, required = true) String version) throws Exception {
        ...
        try {
            ...
            return new AWSApiVolumeServiceImpl().createVolume(wrapper);
        } catch (Exception e) {
