...
import static io.cloudslang.content.datetime.utils.InputsValidation.verifySchedulerInputs;
...
public class SchedulerTime {
    ...
    public Map<String, String> execute(@Param(value = SCHEDULER_TIME, required = true, description = SCHEDULER_TIME_DESC) String schedulerTime,
        ...
        try {
            ...
            return SchedulerService.getSchedulerTime(schedulerTime, schedulerTimeZone);
