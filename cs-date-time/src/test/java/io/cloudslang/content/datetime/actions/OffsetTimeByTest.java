...
public class OffsetTimeByTest {
    ...
    public void test_localeEnglish() {
        ...
        final Map<String, String> result = offsetTimeBy.execute("April 26, 2016 1:32:20 PM EEST", "5", "en", "US");
    ...
    public void test_localeSpanish() {
        ...
        final Map<String, String> result = offsetTimeBy.execute("26 de abril de 2016 13:32:20 EEST", "5", "es", "SP");
        assertTrue(!result.get(Constants.OutputNames.RETURN_RESULT).isEmpty());
        assertEquals("0", result.get(Constants.OutputNames.RETURN_CODE));
    }
    ...
    public void test_localeUnix() {
        ...
        final Map<String, String> result = offsetTimeBy.execute("1000", "5", "unix", "US");
        assertTrue(!result.get(Constants.OutputNames.RETURN_RESULT).isEmpty());
        assertEquals("0", result.get(Constants.OutputNames.RETURN_CODE));
    }
    ...
    public void test_LocaleCountryNull() {
        ...
        final Map<String, String> result = offsetTimeBy.execute("April 26, 2016 1:32:20 PM EEST", "5", "en", null);
        assertTrue(!result.get(Constants.OutputNames.RETURN_RESULT).isEmpty());
        assertEquals("0", result.get(Constants.OutputNames.RETURN_CODE));
    }
}
