...
import main.java.io.cloudslang.content.ldap.constants.PropNames;
...
public class SSLUtils {
    ...
    public static void addSSLSettings(boolean trustAllRoots, String keystore,
        ...
        if (keystore.length() == 0 && !trustAllRoots) {
            ...
            if (null != keystorePassword) {
                if (StringUtils.EMPTY.equals(keystorePassword)) {
                    keystorePassword = Constants.DEFAULT_PASSWORD_FOR_STORE;
                }
            }
        ...
        if (trustKeystore.length() == 0 && !trustAllRoots) {
            ...
            if (storeExists) {
                if (isEmpty(trustPassword)) {
                    trustPassword = Constants.DEFAULT_PASSWORD_FOR_STORE;
                }
            } else {
                trustPassword = null;
            }
        ...
        SSLContext context = SSLContext.getInstance(Constants.SSL);
