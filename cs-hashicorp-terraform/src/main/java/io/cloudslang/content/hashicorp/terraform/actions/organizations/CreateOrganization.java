...
import static io.cloudslang.content.hashicorp.terraform.services.OrganizationImpl.createOrganization;
import static io.cloudslang.content.hashicorp.terraform.utils.Constants.Common.*;
import static io.cloudslang.content.hashicorp.terraform.utils.Constants.CreateOrganizationConstants.CREATE_ORGANIZATION_OPERATION_NAME;
...
public class CreateOrganization {
    ...
    @Action(name = CREATE_ORGANIZATION_OPERATION_NAME,
            description = CREATE_ORGANIZATION_DESC,
            outputs = {
    ...
    public Map<String, String> execute(@Param(value = AUTH_TOKEN, encrypted = true, required = true, description = AUTH_TOKEN_DESC) String authToken,
        ...
        try {
            final Map<String, String> result = createOrganization(TerraformOrganizationInputs.builder()
