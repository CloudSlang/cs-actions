...
public class TerraformCommonInputs {
    ...
    @java.beans.ConstructorProperties({"authToken", "organizationName", "proxyHost", "proxyPort", "proxyUsername",
    ...
    private TerraformCommonInputs(String authToken, String organizationName, String proxyHost, String proxyPort,
                                  ...
                                  String keepAlive, String responseCharacterSet, String connectionsMaxPerRoot, String connectionsMaxTotal) {
    ...
    @NotNull
    public static TerraformCommonInputsBuilder builder() {
        return new TerraformCommonInputsBuilder();
    }
    ...
    public static class TerraformCommonInputsBuilder {
        ...
        public TerraformCommonInputs build() {
            return new TerraformCommonInputs(authToken, organizationName, proxyHost, proxyPort, proxyUsername, proxyPassword,
