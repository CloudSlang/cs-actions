...
import static io.cloudslang.content.hashicorp.terraform.services.OrganizationImpl.getOrganizationDetails;
...
import static io.cloudslang.content.hashicorp.terraform.utils.Constants.GetOrganizationDetailsConstants.GET_ORGANIZATION_DETAILS_OPERATION_NAME;
import static io.cloudslang.content.hashicorp.terraform.utils.Descriptions.Common.*;
import static io.cloudslang.content.hashicorp.terraform.utils.Descriptions.GetOrganizationDetails.*;
...
public class GetOrganizationDetails {

    @Action(name = GET_ORGANIZATION_DETAILS_OPERATION_NAME,
            description = GET_ORGANIZATION_DETAILS_DESC,
            outputs = {
    ...
    public Map<String, String> execute(@Param(value = AUTH_TOKEN, encrypted = true, required = true, description = AUTH_TOKEN_DESC) String authToken,
        ...
        try {
            final Map<String, String> result = getOrganizationDetails(TerraformOrganizationInputs.builder()
