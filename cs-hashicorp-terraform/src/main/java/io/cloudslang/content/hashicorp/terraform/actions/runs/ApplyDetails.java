...
public class ApplyDetails {
    ...
    @Action(name = GET_APPLY_DETAILS_OPERATION_NAME,
            description = GET_APPLY_DETAILS_DESC,
            outputs = {
    ...
    public Map<String, String> execute(@Param(value = AUTH_TOKEN, encrypted = true, required = true, description = AUTH_TOKEN_DESC) String authToken,
                                       @Param(value = APPLY_ID, required = true, description = APPLY_ID_DESC) String applyId,
