...
import static io.cloudslang.content.sharepoint.utils.Descriptions.MoveItemDesc.*;
import static io.cloudslang.content.sharepoint.utils.Descriptions.MoveItemDesc.NAME;
import static io.cloudslang.content.sharepoint.utils.Inputs.CommonInputs.*;
import static io.cloudslang.content.sharepoint.utils.Inputs.MoveItemInputs.*;
...
import static io.cloudslang.content.sharepoint.utils.Utils.buildMoveItemURL;
    ...
    public Map<String, String> execute(
        ...
        try {
            ...
            Map<String, String> result = new HttpClientPatchAction().execute(
                    buildMoveItemURL(siteId, driveId, itemId),
                    ANONYMOUS,
                    EMPTY,
                    EMPTY,
                    TRUE,
