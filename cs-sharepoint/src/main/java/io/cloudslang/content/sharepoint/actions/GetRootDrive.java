...
import static io.cloudslang.content.httpclient.utils.Constants.TLSv13;
...
public class GetRootDrive {
    @Action(name = "Get the root drive for Office 365 Sharepoint",
            outputs = {
    ...
    public Map<String, String> execute(
        ...
        try {
            Map<String, String> result = new HttpClientGetAction().execute(
                    ...
                    EMPTY,
                    FALSE,
                    CONNECTIONS_MAX_PER_ROUTE_VALUE,
