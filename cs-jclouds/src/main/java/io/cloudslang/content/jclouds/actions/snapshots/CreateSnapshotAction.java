...
import static io.cloudslang.content.jclouds.entities.constants.Inputs.CustomInputs.VOLUME_ID;

import static io.cloudslang.content.jclouds.entities.constants.Inputs.VolumeInputs.SNAPSHOT_DESCRIPTION;
...
import static io.cloudslang.content.jclouds.entities.constants.Constants.QueryApiActions.CREATE_SNAPSHOT;
...
public class CreateSnapshotAction {
    ...
    public Map<String, String> createSnapshot(@Param(value = ENDPOINT, required = true) String endpoint,
