...
import static io.cloudslang.content.jclouds.entities.constants.Inputs.CustomInputs.KMS_KEY_ID;
import static io.cloudslang.content.jclouds.entities.constants.Inputs.CustomInputs.VOLUME_TYPE;

import static io.cloudslang.content.jclouds.entities.constants.Inputs.VolumeInputs.ENCRYPTED;
import static io.cloudslang.content.jclouds.entities.constants.Inputs.VolumeInputs.IOPS;
import static io.cloudslang.content.jclouds.entities.constants.Inputs.VolumeInputs.SIZE;
import static io.cloudslang.content.jclouds.entities.constants.Inputs.VolumeInputs.SNAPSHOT_ID;
...
import static io.cloudslang.content.jclouds.entities.constants.Constants.QueryApiActions.CREATE_VOLUME;
...
public class CreateVolumeAction {
    ...
    public Map<String, String> createVolume(@Param(value = ENDPOINT, required = true) String endpoint,
