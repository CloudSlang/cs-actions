...
import static io.cloudslang.content.jclouds.entities.constants.Inputs.NetworkInputs.DEVICE_INDEX;
...
import static io.cloudslang.content.jclouds.entities.constants.Constants.QueryApiActions.ATTACH_NETWORK_INTERFACE;
...
public class AttachNetworkInterfaceAction {
    ...
    public Map<String, String> attachNetworkInterface(@Param(value = ENDPOINT, required = true) String endpoint,
