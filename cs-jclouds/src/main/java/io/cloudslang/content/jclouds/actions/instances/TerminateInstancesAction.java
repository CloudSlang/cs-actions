...
import static io.cloudslang.content.jclouds.entities.constants.Constants.QueryApiActions.TERMINATE_INSTANCES;
...
public class TerminateInstancesAction {
    ...
    public Map<String, String> terminateInstances(@Param(value = ENDPOINT, required = true) String endpoint,
