...
public class DisassociateAddressAction {
    ...
    public Map<String, String> disassociateAddress(@Param(value = Inputs.CommonInputs.ENDPOINT, required = true) String endpoint,
        ...
        try {
            CommonInputs commonInputs = new CommonInputs.Builder()
                    ...
                    .withVersion(version)
                    .withAction(Constants.QueryApiActions.DISASSOCIATE_ADDRESS)
