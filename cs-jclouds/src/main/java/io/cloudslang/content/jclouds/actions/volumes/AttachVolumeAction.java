...
import static io.cloudslang.content.jclouds.entities.constants.Constants.QueryApiActions.ATTACH_VOLUME;
...
public class AttachVolumeAction {
    ...
    public Map<String, String> attachVolume(@Param(value = ENDPOINT, required = true) String endpoint,
