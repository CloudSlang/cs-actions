...
public class AmazonTagServiceImpl extends JCloudsService implements TagService {
    ...
    public void applyToResources(CommonInputs commonInputs, CustomInputs customInputs) {
        ...
        Map<String, String> tagsMap = filtersHelper.getTagsMap(customInputs, commonInputs.getDelimiter());
        Set<String> resourcesIdsList = filtersHelper.getResourcesIdsList(customInputs.getResourceIdsString(), commonInputs.getDelimiter());
