...
import static io.cloudslang.content.jclouds.entities.constants.Inputs.CustomInputs.DOMAIN;
...
import static io.cloudslang.content.jclouds.entities.constants.Constants.QueryApiActions.ALLOCATE_ADDRESS;
...
public class AllocateAddressAction {
    ...
    public Map<String, String> allocateAddress(@Param(value = ENDPOINT, required = true) String endpoint,
