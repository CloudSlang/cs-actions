...
import static io.cloudslang.content.jclouds.entities.constants.Inputs.CustomInputs.ALLOCATION_ID;
import static io.cloudslang.content.jclouds.entities.constants.Inputs.CustomInputs.INSTANCE_ID;

import static io.cloudslang.content.jclouds.entities.constants.Inputs.ElasticIpInputs.ALLOW_REASSOCIATION;
...
import static io.cloudslang.content.jclouds.entities.constants.Constants.QueryApiActions.ASSOCIATE_ADDRESS;
...
public class AssociateAddressAction {
    ...
    public Map<String, String> associateAddress(@Param(value = ENDPOINT, required = true) String endpoint,
