...
public class AssociateAddressAction {
     ...
     *                                         Default: ""
     * @param instanceId                       Optional - ID of the instance. This is required for EC2-Classic. For EC2-VPC,
     *                                         you can specify either the instance ID or the network interface ID, but
     *                                         not both. The operation fails if you specify an instance ID unless exactly
     *                                         one network interface is attached.
     *                                         Example: "i-12345678"
     *                                         Default: ""
     * @param allowReassociation               Optional - [EC2-VPC] For a VPC in an EC2-Classic account, specify "true"
     *                                         to allow an Elastic IP address that is already associated with an instance
     *                                         or network interface to be re-associated with the specified instance or
     *                                         network interface. Otherwise, the operation fails. In a VPC in an EC2-VPC-only
     *                                         account, re-association is automatic, therefore you can specify "false" to
     ...
     *                                         Default: "false"
     * @param networkInterfaceId               Optional - [EC2-VPC] ID of the network interface. If the instance has more
     *                                         than one network interface, you must specify a network interface ID.
     *                                         Example: "eni-12345678"
     *                                         Default: ""
     * @param networkInterfacePrivateIpAddress Optional - [EC2-VPC] The primary or secondary private IP address to associate
    ...
    public Map<String, String> associateAddress(@Param(value = Inputs.CommonInputs.ENDPOINT, required = true) String endpoint,
                                                ...
                                                @Param(value = Inputs.NetworkInputs.ALLOW_REASSOCIATION) String allowReassociation,
