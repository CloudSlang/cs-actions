...
package io.cloudslang.content.oauth.actions;
...
import io.cloudslang.content.oauth.entities.AuthorizationTokenInputs;
import io.cloudslang.content.oauth.services.AuthorizationTokenImpl;
...
import static io.cloudslang.content.oauth.utils.Descriptions.Common.*;
import static io.cloudslang.content.oauth.utils.Descriptions.GetAuthorizationToken.RETURN_CODE_DESC;
import static io.cloudslang.content.oauth.utils.Descriptions.GetAuthorizationToken.*;
import static io.cloudslang.content.oauth.utils.Inputs.AuthorizationInputs.*;
import static io.cloudslang.content.oauth.utils.Inputs.CommonInputs.*;
import static io.cloudslang.content.oauth.utils.InputsValidation.verifyAuthorizationInputs;
import static io.cloudslang.content.oauth.utils.Outputs.AuthorizationOutputs.AUTH_TOKEN;
...
public class GetAuthorizationToken {
     ...
     */
    @Action(name = "Get OAuth 2 Authorization Token",
            outputs = {
