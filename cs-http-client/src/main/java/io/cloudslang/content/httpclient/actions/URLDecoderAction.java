...
import static io.cloudslang.content.httpclient.build.Utils.DEFAULT_CHARACTER_SET;
...
public class URLDecoderAction {
    ...
    public Map<String, String> execute(
        ...
        try {
            final String urlCharacterSet = defaultIfEmpty(characterSet, DEFAULT_CHARACTER_SET);
            final String returnResult = URLDecoder.decode(url, urlCharacterSet);
