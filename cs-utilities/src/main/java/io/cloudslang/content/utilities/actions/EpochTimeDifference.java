...
import static io.cloudslang.content.utilities.util.InputsValidation.verifyEpochTimeInputs;
...
public class EpochTimeDifference {
    ...
    public Map<String, String> execute(
        ...
        try {
            ...
            return ConvertEpochTimeImpl.getTimeDifference(epochTime, timeZone);
