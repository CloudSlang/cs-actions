...
public class LocalPingDescriptions {
    ...
    public static class InputsDescription {
        public static final String IP_VERSION_INPUT_DESC = "IP version forced to the ping command executed on the target host. " +
                ...
                "Valid values: 4, 6, '' (empty string without quotes). " +
                "Default: ''.";
        public static final String PACKET_SIZE_INPUT_DESC = "The size of the ping packet. Default: ''.";
        ...
        public static final String PACKETS_COUNT_INPUT_DESC = "The number of packets to send. Default: ''.";
    }
