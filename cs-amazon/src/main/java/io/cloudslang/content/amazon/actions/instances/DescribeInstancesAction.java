...
public class DescribeInstancesAction {
    ...
    public Map<String, String> execute(@Param(value = ENDPOINT) String endpoint,
        ...
        try {
            ...
            CustomInputs customInputs = new CustomInputs.Builder().build();
            NetworkInputs networkInputs = new NetworkInputs.Builder().build();
            InstanceInputs instanceInputs = new InstanceInputs.Builder().build();

            return new QueryApiExecutor().execute(commonInputs, customInputs, networkInputs, instanceInputs);
        } catch (Exception e) {
