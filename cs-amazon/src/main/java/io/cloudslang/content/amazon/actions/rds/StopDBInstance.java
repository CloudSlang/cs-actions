...
import static io.cloudslang.content.amazon.entities.constants.Descriptions.StopDBInstanceAction.DB_SNAPSHOT_IDENTIFIER_DESC;
import static io.cloudslang.content.amazon.entities.constants.Descriptions.StopDBInstanceAction.STOP_DB_INSTANCE_DESC;
...
import static io.cloudslang.content.amazon.entities.constants.Inputs.StopDBInstanceInputs.DB_SNAPSHOT_IDENTIFIER;
import static io.cloudslang.content.amazon.entities.constants.Inputs.StopDBInstanceInputs.STOP_DB_INSTANCE;
...
public class StopDBInstance {
    @Action(name = STOP_DB_INSTANCE, description = STOP_DB_INSTANCE_DESC,
            outputs = {
    ...
    public Map<String, String> execute(@Param(value = ACCESS_KEY_ID, required = true, description = ACCESS_KEY_ID_DESC) final String accessKeyID,
                                       ...
                                       @Param(value = DB_SNAPSHOT_IDENTIFIER, description = DB_SNAPSHOT_IDENTIFIER_DESC) String dbSnapshotIdentifier,
        ...
        try {
            ...
            final DBInstance result = AmazonRDSService.stopRDSInstance(dbInstanceIdentifier, dbSnapshotIdentifier, amazonRDS);
