...
public class ServiceCatalogUtil {
    ...
    public static List<UpdateProvisioningParameter> toArrayOfUpdateParameters(final String updateParameters, final String delimiter) {
        ...
        for (String line : updateParameters.split(delimiter)){
            ...
            if(paramLine.isValid()){
                ...
                updateParamter.setUsePreviousValue(false);
