...
import static io.cloudslang.content.amazon.entities.constants.Constants.S3QueryApiActions.LIST_ALL_MY_BUCKETS;
...
public class ListAllMyBuckets {
    ...
    public Map<String, String> execute(@Param(value = ENDPOINT) String endpoint,
        ...
        try {
            ...
            String formattedHeaders = InputsUtil.getS3Headers(headers, S3_API, EMPTY);
            ...
            final CommonInputs commonInputs = new CommonInputs.Builder()
                    ...
                    .withHeaders(formattedHeaders)
                    .withQueryParams(queryParams)
                    .withVersion(version)
                    .withAction(LIST_ALL_MY_BUCKETS)
            ...
            return new QueryApiExecutor().execute(commonInputs);
