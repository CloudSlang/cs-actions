...
import io.cloudslang.content.active_directory.services.users.DeleteUserService;
...
import static io.cloudslang.content.active_directory.constants.Descriptions.DeleteUser.*;
...
public class DeleteUserAction {
    ...
    /**
     * Deletes an user from Active Directory.
     *
    ...
    @Action(name = "Delete User", description = DELETE_USER_DESC,
            outputs = {
                    @Output(value = OutputNames.RETURN_RESULT, description = RETURN_RESULT_DELETE_USER),
                    @Output(value = OutputNames.RESULT_USER_DN, description = RESULT_USER_DN_DELETED_DESC),
