...
import io.cloudslang.content.active_directory.entities.ResetUserPasswordInput;
import io.cloudslang.content.active_directory.services.users.ResetUserPasswordService;
...
import static io.cloudslang.content.active_directory.constants.Descriptions.ResetUserPassword.RETURN_CODE_DESC;
import static io.cloudslang.content.active_directory.constants.Descriptions.ResetUserPassword.*;
import static io.cloudslang.content.active_directory.constants.Descriptions.ResetUserPassword.RETURN_RESULT_DESC;
...
public class ResetUserPasswordAction {
    ...
    @Action(name = "Reset User Password", description = RESET_USER_PASSWORD_DESC,
            outputs = {
    ...
    public Map<String, String> execute(
            ...
            @Param(value = InputNames.USER_DISTINGUISHED_NAME, required = true, description = DISTINGUISHED_NAME_DESC) String userDistinguishedName,
            @Param(value = InputNames.USER_PASSWORD, required = true, encrypted = true, description = USER_PASSWORD_DESC) String userPassword,
