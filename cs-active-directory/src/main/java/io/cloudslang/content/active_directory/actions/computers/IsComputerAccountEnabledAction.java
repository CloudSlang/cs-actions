...
import io.cloudslang.content.active_directory.services.computers.IsComputerAccountEnabledService;
...
import static io.cloudslang.content.active_directory.constants.Descriptions.GetComputerAccountOU.SUCCESS_DESC;
import static io.cloudslang.content.active_directory.constants.Descriptions.IsComputerAccountEnabled.*;
...
public class IsComputerAccountEnabledAction {
     ...
     */
    @Action(name = "Is Computer Account Enabled", description = IS_COMPUTER_ACCOUNT_ENABLED_DESC,
            outputs = {
                    @Output(value = OutputNames.RETURN_RESULT, description = RETURN_RESULT_DESC),
                    @Output(value = OutputNames.RESULT_COMPUTER_DN, description = IS_COMPUTER_ACCOUNT_ENABLED_RESULT_OU_DESC),
