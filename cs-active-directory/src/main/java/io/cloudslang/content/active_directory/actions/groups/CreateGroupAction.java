...
import io.cloudslang.content.active_directory.services.groups.CreateGroupService;
...
import static io.cloudslang.content.active_directory.constants.Descriptions.CreateGroup.*;
...
public class CreateGroupAction {
     ...
     * @param distinguishedName    The Organizational Unit DN or Common Name DN to add the group to.
