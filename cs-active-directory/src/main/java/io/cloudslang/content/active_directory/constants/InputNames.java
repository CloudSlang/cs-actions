 ...
 * limitations under the License.
 */
package io.cloudslang.content.active_directory.constants;
...
public final class InputNames {
    ...
    public static final String USER_DISTINGUISHED_NAME = "userDistinguishedName";
    public static final String GROUP_COMMON_NAME = "groupCommonName";
    public static final String GROUP_TYPE = "groupType";
    public static final String GROUP_DISTINGUISHED_NAME = "groupDistinguishedName";
