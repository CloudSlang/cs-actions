...
import io.cloudslang.content.active_directory.services.computers.DisableComputerAccountService;
...
import static io.cloudslang.content.active_directory.constants.Descriptions.CreateComputerAccount.DISTINGUISHED_NAME_DESC;
import static io.cloudslang.content.active_directory.constants.Descriptions.DisableComputerAccount.*;
...
public class DisableComputerAccountAction {
     ...
     */
    @Action(name = "Disable Computer Account", description = DISABLE_COMPUTER_ACCOUNT_DESC,
            outputs = {
                    @Output(value = OutputNames.RETURN_RESULT, description = RETURN_RESULT_DESC),
                    @Output(value = OutputNames.RESULT_COMPUTER_DN, description = RESULT_DISABLE_COMPUTER_DN_DESC),
