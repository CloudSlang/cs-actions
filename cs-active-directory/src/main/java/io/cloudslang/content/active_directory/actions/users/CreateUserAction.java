...
import io.cloudslang.content.active_directory.services.users.CreateUserService;
...
public class CreateUserAction {
    ...
    @Action(name = "Create User", description = CREATE_USER_DESC,
            outputs = {
                    @Output(value = OutputNames.RETURN_RESULT, description = RETURN_RESULT_CREATE_USER),
                    @Output(value = OutputNames.RESULT_USER_DN, description = RESULT_USER_DN_DESC),
